...
import 'package:newsapp/modules/headlineScreen_module/pages/headLinePage.dart';
import 'package:newsapp/ui_utils/app_text.dart';

class HeadlineCard extends StatelessWidget {
  Articles articles;
  HeadlineCard({super.key, required this.articles});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        InkWell(
          onTap: () {
            Get.to(() => HeadlineScreen(articles: articles));
          },
          child: Container(
